@echo off
:: Discord: jinx#6828 | If you're gonna use any part of the code give me credit !
...
if errorlevel 0 (
   echo Subdomain found: dev.%glue% && echo.
)
ping -l 100 test.%glue% > nul
if errorlevel 0 (
   echo Subdomain found: test.%glue% && echo.
)
ping -l 100 ovh.%glue% > nul
if errorlevel 0 (
   echo Subdomain found: ovh.%glue% && echo.
)
ping -l 100 staff.%glue% > nul
if errorlevel 0 (
   echo Subdomain found: staff.%glue% && echo.
)
ping -l 100 jogar.%glue% > nul
if errorlevel 0 (
   echo Subdomain found: jogar.%glue% && echo.
)
ping -l 100 play.%glue% > nul
if errorlevel 0 (
   echo Subdomain found: play.%glue% && echo.
)
ping -l 100 mc.%glue% > nul
if errorlevel 0 (
   echo Subdomain found: mc.%glue% && echo.
)
ping -l www.%glue% > nul
if errorlevel 0 (
   echo Subdomain found: www.%glue% && echo.
)
ping -l 100 build.%glue% > nul
if errorlevel 0 (
   echo Subdomain found: build.%glue% && echo.
)
ping -l 100 store.%glue% > nul
if errorlevel 0 (
   echo Subdomain found: store.%glue% && echo.
)
ping -l 100 na.%glue% > nul
if errorlevel 0 (
   echo Subdomain found: na.%glue% && echo.
)
ping -l 100 as.%glue% > nul
if errorlevel 0 (
   echo Subdomain found: as.%glue% && echo.
)
ping -l 100 eu.%glue% > nul
if errorlevel 0 (
   echo Subdomain found: eu.%glue% && echo.
)
ping -l 100 node01.%glue% > nul
if errorlevel 0 (
   echo Subdomain found: node01.%glue% && echo.
)
ping -l 100 node02.%glue% > nul
if errorlevel 0 (
   echo Subdomain found: node02.%glue% && echo.
)
ping -l 100 node03.%glue% > nul
if errorlevel 0 (
   echo Subdomain found: node03.%glue% && echo.
)
ping -l 100 node04.%glue% > nul
if errorlevel 0 (
   echo Subdomain found: node04.%glue% && echo.
)
ping -l 100 node05.%glue% > nul
if errorlevel 0 (
   echo Subdomain found: node05.%glue% && echo.
)
ping -l 100 vote.%glue% > nul
if errorlevel 0 (
   echo Subdomain found: vote.%glue% && echo.
)
ping -l 100 vote1.%glue% > nul
if errorlevel 0 (
   echo Subdomain found: vote1.%glue% && echo.
)
ping -l 100 vote2.%glue% > nul
if errorlevel 0 (
   echo Subdomain found: vote2.%glue% && echo.
)
ping -l 100 vote3.%glue% > nul
if errorlevel 0 (
   echo Subdomain found: vote3.%glue% && echo.
)
ping -l 100 vote4.%glue% > nul
if errorlevel 0 (
   echo Subdomain found: vote5.%glue% && echo.
)
